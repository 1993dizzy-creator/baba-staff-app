export default function AdminPosRecipesPage() {
  return (
    <main style={styles.page}>
      <section style={styles.card}>
        <div style={styles.eyebrow}>CUKCUK POS</div>
        <h1 style={styles.title}>레시피 설정</h1>
        <p style={styles.description}>
          칵테일, 음식, 콤보 판매 시 여러 재료가 차감되도록 레시피를 구성하는 화면입니다.
        </p>
        <div style={styles.notice}>레시피 차감은 direct/manual 안정화 후 연결합니다.</div>
      </section>
    </main>
  );
}
