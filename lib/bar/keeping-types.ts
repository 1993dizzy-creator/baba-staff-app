...
export type BarKeeping = {
  id: number; customerName: string; customerIdentifier: string | null; liquorName: string; liquorSource: "inventory" | "external" | null; inventoryItemId: number | null; useCount: number; note: string | null;
...
export type BarKeepingListItem = Pick<BarKeeping, "id" | "customerName" | "liquorName" | "useCount" | "zoneCode" | "status" | "closeReason" | "remainingPercent" | "thumbnailUrl" | "storedAt" | "lastUsedAt" | "expiresAt" | "closedAt" | "updatedAt" | "isExpirySoon" | "isExpired"> & { customerIdentifierMasked: string | null };
