...
export function buildEmployeePaymentSnapshot(employee:PayrollOverviewEmployee,raw:PayrollRunEmployeeInput,sourceSnapshot:Record<string,unknown>){
  return {employee,contractSnapshot:raw.contractSnapshot,attendanceSnapshot:raw.attendanceSnapshot,insuranceSnapshot:raw.insuranceSnapshot,levelSnapshot:employee.levelInfo,adjustmentsSnapshot:employee.adjustments,automaticPenaltiesSnapshot:employee.automaticPenalties,sourceSnapshot};
}
