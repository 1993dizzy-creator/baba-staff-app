export const attendanceText = {
  ko: {
    ...
    noRecordHint: "해당 날짜의 근태 기록이 없습니다. 근무 기록, 휴무 또는 무단결근으로 처리할 수 있습니다.",
    createRecordTab: "근무 기록 추가",
    createLeaveTab: "휴무 처리",
    createUnauthorizedAbsenceTab: "무단결근",
    unauthorizedAbsenceTitle: "무단결근 처리",
    unauthorizedAbsenceDescription: "해당 날짜를 무단결근으로 확정합니다. 급여설정의 무단결근 기준에 따라 급여 패널티가 적용됩니다.",
    unauthorizedAbsenceCurrentPolicy: "현재 기준: 일당 {days}일분",
    unauthorizedAbsenceReason: "사유",
    unauthorizedAbsenceReasonOptional: "사유 (선택)",
    unauthorizedAbsenceConfirm: "무단결근 확정",
    unauthorizedAbsenceCancel: "무단결근 취소",
    unauthorizedAbsenceCancelReason: "취소 사유",
    unauthorizedAbsenceCancelReasonOptional: "취소 사유 (선택)",
    unauthorizedAbsenceCancelConfirm: "무단결근을 취소하시겠습니까?",
    unauthorizedAbsenceActor: "처리자",
    unauthorizedAbsenceProcessedAt: "처리시간",
  ...
  vi: {
    ...
    workNormal: "Đúng giờ",
    workLate: "Đi muộn",
    unauthorizedAbsence: "Vắng không phép",
    checkIn: "Vào",
    checkOut: "Về",
    workTime: "Làm",
    ...
    noRecordHint: "Ngày này chưa có dữ liệu chấm công. Có thể thêm ca làm việc, xử lý nghỉ phép hoặc xác nhận vắng không phép.",
    createRecordTab: "Thêm ca làm việc",
    createLeaveTab: "Xử lý nghỉ phép",
    createUnauthorizedAbsenceTab: "Vắng không phép",
    unauthorizedAbsenceTitle: "Xử lý vắng không phép",
    unauthorizedAbsenceDescription: "Xác nhận ngày này là vắng không phép. Khoản phạt sẽ được áp dụng theo cài đặt lương.",
    unauthorizedAbsenceCurrentPolicy: "Mức hiện tại: {days} ngày lương",
    unauthorizedAbsenceReason: "Lý do",
    unauthorizedAbsenceReasonOptional: "Lý do (tùy chọn)",
    unauthorizedAbsenceConfirm: "Xác nhận vắng không phép",
    unauthorizedAbsenceCancel: "Hủy vắng không phép",
    unauthorizedAbsenceCancelReason: "Lý do hủy",
    unauthorizedAbsenceCancelReasonOptional: "Lý do hủy (tùy chọn)",
    unauthorizedAbsenceCancelConfirm: "Bạn có muốn hủy vắng không phép không?",
    unauthorizedAbsenceActor: "Người xử lý",
    unauthorizedAbsenceProcessedAt: "Thời gian xử lý",
