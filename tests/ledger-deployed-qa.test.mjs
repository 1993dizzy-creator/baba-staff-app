...
function pageFixture(path, states, fetcher=()=>{throw Error('Unexpected network request');}, lang='ko', businessDate) {
  ...
  const deps={
    ...
    './PaymentVerificationSection':{default:()=>null},
    '@/lib/ledger/partial-payable-payment':require('../lib/ledger/partial-payable-payment.ts'),
    '@/lib/ledger/payable-display-groups':require('../lib/ledger/payable-display-groups.ts'),
