...
test("current amount includes manual and automatic incentives exactly once and deducts employee insurance exactly once",()=>{assert.match(overview,/incentiveAmount=manualIncentiveAmount\+automaticIncentiveAmount/);assert.match(overview,/automaticPreInsuranceAmount\+manualIncentiveAmount-manualPenaltyAmount/);assert.match(overview,/netPayoutAmount=preInsurancePayoutAmount-employeeInsuranceDeductionAmount/);assert.match(overview,/automaticPenaltyAmount\+manualPenaltyAmount/)});
