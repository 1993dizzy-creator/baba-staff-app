...
export type PublicMonthlyAttendanceSummary={userId:number;actualWorkDays:number;lateCount:number;earlyLeaveCount:number;blockingCount:number;perfectAttendanceCurrent:boolean};
