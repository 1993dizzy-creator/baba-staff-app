...
export type PublicMonthlyAttendanceSummary={userId:number;actualWorkDays:number;lateCount:number;earlyLeaveCount:number;unauthorizedAbsenceCount:number;blockingCount:number;perfectAttendanceCurrent:boolean;attendanceBonusEligible:boolean};
